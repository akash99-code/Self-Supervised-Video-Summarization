...
class TransformerLegacy(nn.Module):
    ...
    def forward(self, features: th.FloatTensor, mask, lengths: th.LongTensor,
...
class LearnableClsToken(nn.Module):
    ...
    def forward(self, features, mask, lengths):
        ...
        zeros = (self.fixed_ones.unsqueeze(0).repeat(batch, 1) * 0)  # shape (batch, 1)
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask_expanded= None,
                _layer_cache=None):
        """
